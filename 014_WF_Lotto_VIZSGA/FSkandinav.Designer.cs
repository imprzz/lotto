namespace NSLotto
{
	partial class FSkandinav
	{
		...
		private void InitializeComponent()
		{
			...
			this.PBLogo.Image = global::NSLotto.Properties.Resources.skandinav;
			...
			this.Name = "FSkandinav";
			this.ShowIcon = false;
			this.Text = "Skandináv lottó";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FSkandinav_FormClosing);
			this.Load += new System.EventHandler(this.FSkandinav_Load);
